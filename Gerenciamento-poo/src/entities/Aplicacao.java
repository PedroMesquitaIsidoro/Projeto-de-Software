...
// se der merda contra z até aqui
public class Aplicacao {
			...
			while(opcao != 0) {
				...
				case 1: // TELA PROJETOS 
					...
					while(optProjeto != 0) {
						...
						switch(optProjeto) {
						case 1:
							addNovoProjeto(conta, usuario);
							break;
							
						case 2: 
							atualizarProjeto(conta, usuario);
							break;
							
						case 3:
							removerProjeto(conta, usuario);
							break;
				...
				case 4: //INICIO TELA DE PAGAMETNOS
					...
					while(opt5 != 0) {
						...
						switch(opt5) {
						case 1:
							pagamentos(conta, usuario);
							break;
							
						case 2:
							mostrarPagamentos(conta);
							break;
	...
	void mostrarPagamentos(Conta conta) {
		Scanner sc = new Scanner(System.in);
		Projeto projeto = null;
